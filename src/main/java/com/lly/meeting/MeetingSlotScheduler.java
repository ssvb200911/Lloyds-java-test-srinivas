...
import com.lly.meeting.meetingSchedule.ScheduleIntervalNode;
import com.lly.meeting.model.EmployeeMeetingSchedule;
import com.lly.meeting.model.Result;
...
public class MeetingSlotScheduler {

    private final static Logger LOGGER = Logger.getLogger(MeetingSlotScheduler.class);
    ...
    public void process(@Nonnull final String fileName) throws IOException, InvalidFileFormatException {
        ...
        LOGGER.info("Time taken to process the file is " + totalTime + " milli seconds");
