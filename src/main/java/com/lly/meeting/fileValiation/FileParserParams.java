...
public static final String COMPANY_OFFICE_HOURS_FORMAT = "([01][0-9]|2[0-3])[0-5][0-9]\\s([01][0-9]|2[0-3])[0-5][0-9]";
     ...
     * since REGEX does not validate formats like "2022-15-15" and
     * SimpleDateFormat does not validate format like ("2022-1-1")
     */
    /**
     * Date format in YYYY-MM-DD, an example is "2022-08-17"
     */
    public static final String DATE_FORMAT = "\\d{4}-[01]\\d-[0-3]\\d";

    /**
     * Simple Date formatting in yyyy-MM-dd, an example is "2022-08-17"
     */
    public static final String SIMPLE_DATE_FORMAT = "yyyy-MM-dd";

    /**
     * Simple Date formatting in yyyy-MM-dd HH:mm:ss, an example is "2022-08-17 10:17:06"
     */
    public static final String SIMPLE_DATE_FORMAT_HHMMSS = "yyyy-MM-dd HH:mm:ss";

    /**
     * Simple Date formatting in yyyy-MM-dd HH:mm, an example is "2022-08-21 09:00"
     */
     ...
     * It has 3 subsections, an example is "2022-08-17 10:17:06 EMP001"
     */
     ...
     * It has 3 subsections, an example is "2022-08-21 09:00 2"
     */
